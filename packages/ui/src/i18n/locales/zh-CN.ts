...
const zhCN: Record<string, string> = {
  ...
  "occupationOnboarding.memoryDescription": "让 ZCodium 记住你的偏好与工作上下文。",
  ...
  "startup.global.silent": "正在启动 ZCodium",
  ...
  "startup.global.servicesFailed":
    "本地数据准备已完成，但应用服务启动失败。请复制诊断信息，退出并重新打开 ZCodium。",
  ...
  "startup.global.starting_services": "正在启动 ZCodium",
  "startup.global.ready": "本地数据已就绪",
  "startup.global.failed": "无法完成启动准备",
  "startup.global.help":
    "准备完成后将自动进入 ZCodium。历史记录较多时可能需要较长时间，请保持应用运行。",
  ...
  "settings.computerUse.disabledToast": "电脑控制已关闭，已有对话需重启 ZCodium 后生效。",
  ...
  "conversationShare.permission.linkEditorHint": "可导入到 ZCodium",
  ...
  "login.title": "配置 API",
  "login.description": "配置 API Key 后即可开始使用 ZCodium",
  ...
  "login.expired.title": "配置已失效",
  "login.expired.description": "当前配置已失效，请重新配置 API Key。",
  "login.expired.action": "重新配置",
  ...
  "app.login": "连接使用",
  "app.logout": "断开连接",
  "logout.confirm.title": "断开连接并重启 ZCodium？",
  "logout.confirm.descriptionWithRunningSessions":
    "检测到 {count} 个会话正在运行。断开连接会中断这些会话并重启 App。",
  "logout.confirm.descriptionDefault": "重启 App 后需要重新配置 API Key。",
  ...
  "modelTrajectory.empty": "暂无模型调用记录（仅 ZCodium Agent 会落盘 model-io）",
  ...
  "titleBar.menu.help.about": "关于 ZCodium",
  ...
  "forceUpdate.title": "需要升级 ZCodium 后继续使用",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "工作区目录不存在或无法访问，当前仅可查看历史记录。恢复该目录后重启 ZCodium 即可继续使用。",
  ...
  "settings.terminalFontFamilyDescription":
    "留空时自动探测系统终端配置；填写后作为 ZCodium 终端的字体覆盖。",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "在 ZCodium 运行时将后续操作加入队列，或引导至下一轮工具调用后运行。",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "不能选择 ZCodium 安装目录作为数据存储路径。请选择安装目录之外的文件夹。",
  ...
  "settings.migration.sectionDescription":
    "扫描本机 Claude Code 原生历史，可按 workspace 和时间范围筛选，再把选中的会话导入到对应的 ZCodium 任务列表。",
  ...
  "resourceManager.storage.diskUsage": "ZCodium 占用 {used}",
  ...
  "settings.browser.control.description":
    "启用 Browser Use 插件，让新会话可以通过内置浏览器访问和操作网页。",
  ...
  "settings.browser.desktopOnly": "浏览器数据只能在 ZCodium 桌面端管理。",
  ...
  "settings.browser.import.helperVerificationFailed":
    "ZCodium 的 Windows 安全导入组件校验失败，Cookie 未导入。请重新安装或更新 ZCodium。",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome 在 Windows 上使用 App-Bound 加密保护 Cookie。ZCodium 将为本次导入请求管理员权限，临时启动系统服务，完成后立即删除。不会读取或导入 Chrome 密码。",
  ...
  "settings.mcp.description": "管理 ZCodium Agent 使用的 MCP 服务器配置。",
  ...
  "settings.mcp.host.activeDescription":
    "该 MCP 服务器由 ZCodium 宿主为 {pluginName} 插件提供，运行时身份由宿主管理。",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "当前 ZCodium Agent 不支持 OAuth 状态刷新。请升级或重启 ZCodium，然后重新打开 MCP 设置进行完整刷新。",
  ...
  "settings.mcpServers.import.importing": "正在导入 MCP 服务器到 ZCodium",
  ...
  "settings.modelProvider.startPlan.status.loginExpired": "API Key 已失效，请重新配置",
  ...
  "settings.modelProvider.codingPlan.bigmodel.unregisteredHint":
    "该 BigModel API Key 尚未注册，请先完成注册。",
  ...
  "settings.modelProvider.codingPlan.switchAccount": "切换 API Key",
  ...
  "settings.modelProvider.help.contextWindow":
    "模型一次可处理的上下文容量，单位为 Token。ZCodium 会据此管理上下文。\n请勿超过模型的实际上限。",
  ...
  "settings.modelProvider.help.followRecommendedConfig":
    "根据模型 ID、Base URL 和 API 格式，为您智能匹配推荐配置。ZCodium 会持续更新推荐配置，并自动同步给您。\n如果手动修改某项配置，该项将转为手动管理，不再跟随推荐更新；其他配置仍由智能配置管理。",
  ...
  "settings.usage.entitlementDescription":
    "使用已配置的 Coding Plan 同步套餐等级、5 小时 Prompt 池、每周额度与工具月额度。",
  "settings.usage.entitlementError": "无法读取编程套餐权益。请稍后重试，或检查供应商配置。",
  "usage.error.entitlement.credential":
    "未找到 Coding Plan 权益。请重新配置 API Key，或确认已开通 Coding Plan。",
  ...
  "settings.usage.entitlementLoginRequired": "需要先配置 API Key",
  "settings.usage.entitlementNotConfigured":
    "未找到可查询额度的 Z.ai / BigModel 配置。请先配置 API Key。",
  ...
  "settings.usage.entitlementStatusLoginRequired": "需要配置 API Key",
  "settings.usage.entitlementStatusNoPlan": "未配置",
  ...
  "sidebar.usage.plan.loginRequired": "配置 API Key 后查看剩余额度。",
  "sidebar.usage.plan.notConfigured": "未找到已配置的 Coding Plan。",
  "sidebar.usage.plan.noPlanShort": "未配置",
  ...
  "sidebar.usage.plan.zcodeMcpDescription": "ZCodium 预置插件 MCP 每日合计额度",
  ...
  "chat.planUsage.noPlan": "当前没有有效的 Coding Plan 配置。",
  ...
  "settings.usage.checkApiKey": "检查 API Key",
  "usage.error.stats.credential":
    "无法读取用量统计。请重新配置 API Key，或确认已开通 Coding Plan。",
  ...
  "settings.skills.import.mode.copy.description":
    "将完整技能目录复制到 ZCodium。外部 Agent 目录后续变更不会自动同步。",
  "settings.skills.import.mode.symlink.description":
    "创建指向外部 Agent 技能目录的链接。ZCodium 会跟随来源目录后续变更，但该技能依赖来源路径持续可用。",
  "settings.skills.import.importing": "正在导入技能到 ZCodium",
  ...
  "settings.plugins.store.subtitle": "用插件为 ZCodium 扩展技能、命令与 MCP 能力",
  ...
  "settings.plugins.marketplaces.official": "Z.AI 市场",
  ...
  "settings.plugins.import.mode.copy.description":
    "将完整插件目录复制到 ZCodium，并注册到 plugins.dirs。外部 Agent 目录后续变更不会自动同步。",
  "settings.plugins.import.mode.symlink.description":
    "创建指向外部 Agent 插件目录的链接，并注册到 plugins.dirs。ZCodium 会跟随来源目录后续变更，但该插件依赖来源路径持续可用。",
  "settings.plugins.import.importing": "正在导入插件到 ZCodium",
  ...
  "settings.commands.description":
    "管理 ZCodium Agent 的 .md 命令文件。命令可通过 /command-name 在聊天中调用。",
  ...
  "settings.commands.import.mode.copy.description":
    "将命令文件复制到 ZCodium。外部 Agent 文件后续变更不会自动同步。",
  "settings.commands.import.mode.symlink.description":
    "创建指向外部 Agent 命令文件的链接。ZCodium 会跟随来源文件后续变更，但该命令依赖来源路径持续可用。",
  "settings.commands.import.importing": "正在导入命令到 ZCodium",
  ...
  "settingsSync.discovery.helper": "仅导入缺失项，不会覆盖当前 ZCodium 中已存在的配置。",
  ...
  "onboarding.dialog.title": "欢迎使用 ZCodium",
  "onboarding.dialog.description": "选择如何开始第一次会话。",
  "onboarding.wizard.label": "迁移向导",
  "onboarding.welcome.eyebrow": "首次启动设置",
  "onboarding.welcome.title": "欢迎使用 ZCodium",
  "onboarding.welcome.start": "开始使用 ZCodium",
  ...
  "onboarding.stepDescription.migration": "开始迁移并等待 ZCodium 完成导入。",
  ...
  "onboarding.agentsFile.confirmDescription":
    "将从 {source} 复制到 {target}。\n如果目标文件已存在，ZCodium 默认 AGENTS 配置会被覆盖。",
  ...
  "chat.placeholder.newTask": "向 ZCodium 提问，使用 @ 添加上下文，使用 / 选择命令或能力",
  "chat.placeholder.newTaskMobile": "向 ZCodium 提问…",
  ...
  "workflows.hub.empty.hint":
    "在对话里让 ZCodium 设计工作流，跑通之后再让它保存到项目里。未打开的项目不会出现在这里。",
  ...
  "workflows.hub.detail.whenToUse.help": "给 ZCodium 的路由提示：什么场景该选这个工作流。",
  ...
  "chat.error.retry": "重试",
  "chat.error.reloginProvider": "重新配置 {provider} API Key",
  "chat.error.action.relogin": "重新配置",
  ...
  "chat.error.noAvailableModel": "当前没有可用模型。请配置自定义模型。",
  ...
  "chat.quota.startPlan.modelExhausted": "{model} 可用额度已用完，可切换其他模型。",
  "chat.quota.startPlan.dailyExhausted": "体验额度已用完，请等待额度恢复。",
  "chat.quota.startPlan.concurrentLimit": "当前系统繁忙，请切换模型或稍后再试。",
  "chat.quota.startPlan.concurrentLimit.retryExhausted":
    "当前系统繁忙，当前自动重试已达到最大次数，请稍后再试。",
  ...
  "chat.quota.mcp.codingPlanRequired":
    "当前无 ZCodium MCP「{server}」额度，请登录或开通 Coding Plan 使用。",
  "chat.quota.providerLimited": "当前账户额度或套餐已达到使用限制。请升级或调整套餐后继续。",
  "chat.quota.action.upgrade": "配置",
  "chat.quota.action.renew": "刷新",
  ...
  "chat.permission.cua.allowForProject.description": "本项目后续电脑控制操作不再询问",
  ...
  "feedback.statusHint.needInfo": "还需要你补充一点信息，请看下方 Z.AI 回复。",
  ...
  "feedback.timeline.officialReply": "Z.AI 回复",
  ...
  "feedback.submit.template.section.copyErrorHeading": "ZCodium 报错信息",
  ...
  "feedback.submit.contact.hint": "选填，方便我们后续联系你；也可以填其他联系方式。",
  "feedback.submit.contact.placeholder": "example@domain.com / 微信号 / 其他联系方式",
  ...
  "offPeak.keepAwakeBanner": "ZCodium 运行会话时保持电脑唤醒。",
  ...
  "offPeak.form.instructionsPlaceholder":
    "描述希望 ZCodium 在后台完成的工作、预期结果和约束，例如整理本周代码改动并生成站会摘要…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "ZCodium 电脑控制仍在准备中——工具尚未加载（已加载 {count} 个）。请先授予下方权限，Helper 就绪后工具会自动出现。",
  "chat.cuaReadiness.toolsPreparing":
    "ZCodium 电脑控制仍在准备中——工具尚未加载。请先授予下方权限，Helper 就绪后工具会自动出现。",
  ...
  "cuaPermission.modal.relaunchAppButton": "重启 ZCodium",
  "cuaPermission.modal.relaunchAppHint":
    "重启 Helper 后仍未生效？重启 ZCodium 可彻底重载 Helper 进程。",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "检测到电脑控制工具，但它们并非来自已校验的 ZCodium 插件。请检查插件安装后重新验证。",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "首个会话启动时，ZCodium 会针对该会话精确验证电脑控制工具。",
