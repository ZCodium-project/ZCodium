...
export { default as TelegramChannelIcon } from "./icon-telegram@2x.png";
export { default as WeComChannelIcon } from "./icon-wecom@2x.png";
export { default as WeixinChannelIcon } from "./icon-weixin@2x.png";
